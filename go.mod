...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.1.14 // indirect
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/tiia v1.1.0 // indirect
